...
star = OrderedDict()
star['path'] = 'zams_40Msol/LOGS/profile53.data'
...
numerics['reynolds_target'] = 7.8e3
numerics['prandtl'] = 1
...
dynamics['restart'] = '../msol40_twoRcore_re4e3_damping/final_checkpoint/final_checkpoint_s1.h5'
