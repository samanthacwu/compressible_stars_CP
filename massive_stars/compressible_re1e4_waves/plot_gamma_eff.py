...
for file in files:
    for i, t in enumerate(elltags):
        ...
        with h5py.File('eigenvalues/transfer_{}_eigenvalues.h5'.format(t), 'r') as f:
...
plt.savefig('timestepper_gamma_plot.pdf', dpi=300, bbox_inches='tight')
plt.savefig('timestepper_gamma_plot.png', dpi=300, bbox_inches='tight')
