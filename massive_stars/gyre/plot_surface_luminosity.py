...
#ax1.plot(zamsT, zamsL, c='grey', zorder=0, lw=1)
...
ax1.scatter(0.05, 0.04, c='white', marker='*', s=100, zorder=1, edgecolors='k', linewidths=0.5, transform=ax1.transAxes)
ax1.scatter(0.05, 0.09, c='white', marker='o', s=20, zorder=1, edgecolors='k',  linewidths=0.5, transform=ax1.transAxes)
ax1.text(0.10, 0.0375, 'Simulations', c='k', ha='left', va='center', transform=ax1.transAxes)
ax1.text(0.10, 0.09, 'Observed stars', ha='left', va='center', transform=ax1.transAxes, color='k')#cmap.mpl_colors[3])
ax1.set_xlim(4.75, 4.0)
ax1.set_ylim(1.3, 4.0)
ax1.set_ylabel(r'$\log_{10}\, \mathscr{L} / \mathscr{L}_\odot$')
ax1.set_xlabel(r'$\log_{10}\, $T$_{\rm eff}/$K')
