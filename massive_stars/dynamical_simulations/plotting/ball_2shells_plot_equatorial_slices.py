...
plotter.add_ball_2shells_polar_colormesh(fields=('s1_eq_B', 's1_eq_S1', 's1_eq_S2'), remove_x_mean=True, divide_x_mean=True, **kwargs)
plotter.add_ball_2shells_polar_colormesh(fields=('u_eq_B',  'u_eq_S1', 'u_eq_S2'), vector_ind=0, cmap='PuOr_r', **kwargs)
plotter.add_ball_2shells_polar_colormesh(fields=('u_eq_B',  'u_eq_S1', 'u_eq_S2'), vector_ind=1, cmap='PuOr_r', **kwargs)
plotter.add_ball_2shells_polar_colormesh(fields=('u_eq_B',  'u_eq_S1', 'u_eq_S2'), vector_ind=2, cmap='PuOr_r', **kwargs)
