...
Usage:
    ballShell_plot_mollweide_slices.py <root_dir> [options]
...
plotter.add_mollweide_colormesh('s1_B(r=0.5)', remove_mean=True, **kwargs)
plotter.add_mollweide_colormesh('u_B(r=0.5)', vector_ind=2, cmap='PuOr_r', **kwargs)
plotter.add_mollweide_colormesh('s1_S(r=0.95R)', remove_mean=True, **kwargs)
plotter.add_mollweide_colormesh('u_S(r=0.95R)',vector_ind=2, cmap='PuOr_r', **kwargs)
