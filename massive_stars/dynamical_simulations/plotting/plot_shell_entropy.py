...
Usage:
    plot_shell_entropy.py <root_dir> --r_inner=<r> --r_outer=<r> [options]
    plot_shell_entropy.py <root_dir> --mesa_file=<f> [options]
...
plotter.add_polar_colormesh('s1S_eq', azimuth_basis='phi', remove_x_mean=True, **kwargs)
plotter.add_meridional_colormesh(left='s1S(phi=0)', right='s1S(phi=pi)', colatitude_basis='theta', remove_x_mean=True, **kwargs)
plotter.add_meridional_colormesh(left='s1S(phi=0.5*pi)', right='s1S(phi=1.5*pi)', colatitude_basis='theta', remove_x_mean=True, **kwargs)
