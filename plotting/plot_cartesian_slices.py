"""
This script plots snapshots of the evolution of 2D slices from a 2D simulation in cartesian geometry.
...
Usage:
    plot_cartesian_snapshots.py <root_dir> [options]
...
for tup in fnames:
    plotter.add_colormesh(*tup[0], x_basis='x', y_basis='z', **tup[1])
